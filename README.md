# Hi, I'm Marisa Azevedo 👋

🎓 Master's student in Informatics and Computing Engineering (MEIC) @ Faculdade de Engenharia da Universidade do Porto (FEUP)

🤖 Interested in **Artificial Intelligence**, **Human-Computer Interaction**, and **Frontend Development**
...
| SGI (feup) | [InteractiveGraphicSystems](https://github.com/marisaazevedo/Interactive-Graphic-Systems) | Academic projects and exercises focused on interactive graphics and visualization systems. |
| DS (feup) | [AI4SustainableDevelopment](https://github.com/marisaazevedo/ai4sd) | Artificial intelligence project focused on sustainable development challenges. |
| CMOV (feup) | [WeatherForecastApp](https://github.com/marisaazevedo/WeatherApp) | Weather application providing weather forecasts and real-time weather information. |
| BDBR (feup) | [NonRelationalDatabases](https://github.com/marisaazevedo/Non-Relational_Databases) | Academic projects and exercises focused on non-relational database systems. |
...
| IA (fcup) | [Connect4](https://github.com/marisaazevedo/Connect4) | A Connect Four game implementation featuring game logic, player interactions, and win detection. |
| IA (fcup) | [15Puzzle](https://github.com/marisaazevedo/15Puzzle) | Implementation of the classic 15 Puzzle game, including puzzle generation, movement validation, and solving mechanics. |
...
### 📫 Let's connect
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/marisaazevedooo/)
